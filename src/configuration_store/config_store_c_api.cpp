...
extern "C" float get_z_max_pos_mm() {
    ...
    ret = config_store().z_max_pos.get();
...
extern "C" void set_z_max_pos_mm(float max_pos) {
    ...
    if ((max_pos >= Z_MIN_LEN_LIMIT) && (max_pos <= Z_MAX_LEN_LIMIT)) {
        config_store().z_max_pos.set(max_pos);
    }
...
extern "C" float get_steps_per_unit_x() {
    return std::abs(config_store().steps_per_unit_x.get());
}
extern "C" float get_steps_per_unit_y() {
    return std::abs(config_store().steps_per_unit_y.get());
}
extern "C" float get_steps_per_unit_z() {
    return std::abs(config_store().steps_per_unit_z.get());
}
extern "C" float get_steps_per_unit_e() {
    return std::abs(config_store().steps_per_unit_e.get());
}

extern "C" bool has_inverted_x() {
    return std::signbit(config_store().steps_per_unit_x.get());
}

extern "C" bool has_inverted_y() {
    return std::signbit(config_store().steps_per_unit_y.get());
}

extern "C" bool has_inverted_z() {
    return std::signbit(config_store().steps_per_unit_z.get());
}

extern "C" bool has_inverted_e() {
    return std::signbit(config_store().steps_per_unit_e.get());
}
...
extern "C" void set_steps_per_unit_x(float steps) {
    set_steps_per_unit(steps, config_store().steps_per_unit_x);
}
extern "C" void set_steps_per_unit_y(float steps) {
    set_steps_per_unit(steps, config_store().steps_per_unit_y);
}
extern "C" void set_steps_per_unit_z(float steps) {
    set_steps_per_unit(steps, config_store().steps_per_unit_z);
}
extern "C" void set_steps_per_unit_e(float steps) {
    set_steps_per_unit(steps, config_store().steps_per_unit_e);
}
